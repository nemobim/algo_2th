...
// num1에 넣는거니까 p1에 유효 숫자가 있는지 확인해줘야됨
// 만약 p1이 -1이 되었는데, p2는 아직 0이라서 루프가 한 번 더 돈다고 가정해 보면 
// if (nums1[p1] > nums2[p2]) { // nums1[-1] > nums2[0] 을 비교
// undefined > 5 같은 비교는 항상 **false**가 나와서 답은 맞지만..정교한 식은 아니다 그래서 p1 여부 확인